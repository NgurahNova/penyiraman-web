                      ...
                      <div key={time} className="mb-2">
                        ...
                        >
                          ...
                          <span className="text-xs bg-gray-600 px-2 py-1 rounded-full">
                            {expandedDate === time ? "Sembunyikan" : "Detail"}
                          </span>
                        </div>
                          ...
                          <div className="bg-gray-700 p-4 rounded-b-lg mt-1 text-left">
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div className="text-sm text-gray-300">
                                ...
                                <span
                                  className={`ml-2 ${
                                    historyData[getTodayDate()]?.[time]?.relayA
                                      ? "text-green-500"
                                      : "text-red-500"
                                  }`}
                                >
                              ...
                              <div className="text-sm text-gray-300">
                                ...
                                <span
                                  className={`ml-2 ${
                                    historyData[getTodayDate()]?.[time]?.relayB
                                      ? "text-green-500"
                                      : "text-red-500"
                                  }`}
                                >
                    ...
                    sortedHistoryDates.map((date) => (
                      <div key={date} className="mb-2">
                        ...
                        >
                          ...
                          <span className="text-xs bg-gray-600 px-2 py-1 rounded-full">
                            {expandedDate === date ? "Sembunyikan" : "Detail"}
                          </span>
                        </div>
                              ...
                              >
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                  ...
                                  <div className="text-sm text-gray-300">
                                    TDS:
                                    <span className="ml-2 text-white">
                                      {historyData[date]?.[time]?.tdsValue} PPM
                                    </span>
                                  </div>
                                  <div className="text-sm text-gray-300">
                                    Level Tangki 1:
